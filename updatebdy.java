...
public class updatebdy extends JFrame implements ActionListener
{
	public JPanel p;
...
p.add(b4);
		...
		l13.setIcon(new ImageIcon("bdy1.jpg"));
		setVisible(true);
		setSize(1466,729);
			...
			try
	   		{
		 		...
		 		PreparedStatement st = con.prepareStatement("update birthday set name=?,dob=? where entryid=?");
