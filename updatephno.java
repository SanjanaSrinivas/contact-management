...
public class updatephno extends JFrame implements ActionListener
{
	public JPanel p;
...
p.add(b4);
		...
		l13.setIcon(new ImageIcon("images (1).jpg"));
		setVisible(true);
		setSize(1466,729);
			...
			try
	   		{
		 		...
		 		PreparedStatement st = con.prepareStatement("update phone set name=?,phno1=?,phno2=? where entryid=?");
