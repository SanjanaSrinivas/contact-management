...
public class DeleteEm extends JFrame implements ActionListener

{
public JPanel p;
public JLabel l0,l1,l2,l3,l4,l5,l6,l7,l8,l13;
...
l0.setIcon(new ImageIcon("email.jpg"));

setTitle("  **Delete EmailAddress**");
setVisible(true);
setSize(1366,729);
...
try
	 {
	  Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		...
		Statement st = con.createStatement();
		 ...
		 int z1 = st.executeUpdate("delete from email where entryid="+a); 
