...
public class insertph extends JFrame implements ActionListener
{
	public JPanel p;
	...
	public insertph()	
	{
		...
		l3=new JLabel("Name:");
		//l4=new JLabel(" ");
		l5=new JLabel("phonenumber1:");
		//l6=new JLabel(" ");
		l7=new JLabel("phonenumber2:");
...
p.add(l13);*/
	...
	Connection con = DriverManager.getConnection("Jdbc:Odbc:ASHA-PC","","");
		 ...
		 PreparedStatement st = con.prepareStatement("insert into phone values(?,?,?,?)");
		 st.setString(1,a);
		 st.setString(2,b);
		 st.setString(3,c);
		 st.setString(4,d);
		 ...
		 if (z>0)
              {
			    l5.setText("Insertion Successful");
			}
        }

        catch(SQLException y)
          {
            l5.setText("could not connect");
	System.out.println("SQL exception occured");
           }
        catch(ClassNotFoundException y)
         {
                   l5.setText("could not found");
			//y.printStackTrace();
