...
public class insertbir  extends JFrame implements ActionListener
{
	public JPanel p;
...
p.add(b3);
	...
	Connection con = DriverManager.getConnection("Jdbc:Odbc:ASHA-PC","","");
		 ...
		 PreparedStatement st = con.prepareStatement("insert into birthday values(?,?,?)");
		 st.setString(1,a);
		 st.setString(2,b);
		 st.setString(3,c);
		 //st.setString(4,d);
		 ...
		 if (z>0)
          ...
          {
            l7.setText("could not connect");
	System.out.println("SQL exception occured");
           }
        catch(ClassNotFoundException y)
         {
                   l7.setText("could not found");
			//y.printStackTrace();
