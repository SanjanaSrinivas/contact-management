...
public class DeleteAdd extends JFrame implements ActionListener

{
public JPanel p;
public JLabel l0,l1,l3,l5,l7,l9,l11,l13;
...
l0.setIcon(new ImageIcon("address.jpg"));
      ...
      if(ae.getSource()==b0)	
		{
       			try
			{
		 		...
		 		ResultSet rs = st.executeQuery("select * from address where entryid="+a);
...
try
	 {
	  Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		...
		Statement st = con.createStatement();
		 ...
		 int z1 = st.executeUpdate("delete from address where entryid="+a); 
		...
		/*String str="DELETE FROM address WHERE name='&name'";	
		 
		 Statement st = con.createStatement();


		 int z1 = st.executeUpdate(str); 
