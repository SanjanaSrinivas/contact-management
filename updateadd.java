...
public class updateadd extends JFrame implements ActionListener
{
	public JPanel p;
			...
			try
	   		{
		 		...
		 		PreparedStatement st = con.prepareStatement("update address set name=?,address=?,state=?,country=?,pincode=? where entryid=?");
